...
func TestInstallLocal(t *testing.T) {
	...
	baseConfig := &AutodiscoverNodeInstallerConfig{
		RepositoryChannel: "x",
		AutoUpgrades:      false,
	}
	...
	for _, tt := range []struct {
		name       string
		distroName string
		config     *AutodiscoverNodeInstallerConfig
	}{
		{
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			teleportInstaller, err := NewAutodiscoverNodeInstaller(testConfig)
